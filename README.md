...
```bash
samble-lambda-b$ sam logs -n StockCheckerFunction --stack-name samble-lambda-b --tail
```
...
```bash
samble-lambda-b$ dotnet test tests/StockChecker.Test
```
...
```bash
aws cloudformation delete-stack --stack-name samble-lambda-b
```
